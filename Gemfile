...
gem 'keppler_banners', path: 'rockets/keppler_banners'
gem 'keppler_products', path: 'rockets/keppler_products'
gem 'keppler_form', path: 'rockets/keppler_form'
gem 'keppler_publicity', path: 'rockets/keppler_publicity'